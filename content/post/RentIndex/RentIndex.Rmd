...
#montly data
tempdata <- read_xlsx("RentData/RentalBond_Lodgements_January_2020.xlsx",skip=1,col_names=TRUE) %>% rename(date="Lodgement Date")
tempdata$date <- as.Date(tempdata$date, origin="1899-12-30")
rentdata <- rbind(rentdata,tempdata)
tempdata <- read_xlsx("RentData/RentalBond_Lodgements_February_2020.xlsx",skip=1,col_names=TRUE) %>% rename(date="Lodgement Date")
tempdata$date <- as.Date(tempdata$date, origin="1899-12-30")
rentdata <- rbind(rentdata,tempdata)
tempdata <- read_xlsx("RentData/Rental-bond-lodgements-for-March-2020.xlsx",skip=1,col_names=TRUE) %>% rename(date="Lodgement Date")
tempdata$date <- as.Date(tempdata$date, origin="1899-12-30")
rentdata <- rbind(rentdata,tempdata)
tempdata <- read_xlsx("RentData/RentalBond_Lodgements_April_2020.xlsx",skip=1,col_names=TRUE) %>% rename(date="Lodgement Date")
tempdata$date <- as.Date(tempdata$date, origin="1899-12-30")
rentdata <- rbind(rentdata,tempdata)
tempdata <- read_xlsx("RentData/Rental-Bond-Lodgements-for-May-2020.xlsx",skip=1,col_names=TRUE) %>% rename(date="Lodgement Date")
tempdata$date <- as.Date(tempdata$date, origin="1899-12-30")
rentdata <- rbind(rentdata,tempdata)
tempdata <- read_xlsx("RentData/RentalBond_Lodgements_June_2020.xlsx",skip=1,col_names=TRUE) %>% rename(date="Lodgement Date")
tempdata$date <- as.Date(tempdata$date, origin="1899-12-30")
rentdata <- rbind(rentdata,tempdata)
...
newdates <- tibble(date=seq(as.Date("2016-01-01"), by = "day", length.out = 1915)) %>% filter(date<as.Date("2020-07-01"))
